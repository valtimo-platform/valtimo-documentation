...
This module, together with the specification, is then imported in the app module as shown in [on this page](valtimo-documentation/getting-started/modules/core/plugin.md).
