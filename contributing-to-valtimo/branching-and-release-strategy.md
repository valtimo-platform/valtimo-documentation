...
| ![next-minor scenario](<../.gitbook/assets/next-minor (1).png>) |
| --------------------------------------------------------------- |
...
| ![next-major scenario](<../.gitbook/assets/next-major (1).png>) |
| --------------------------------------------------------------- |
...
| ![back-end libraries scenario](<../.gitbook/assets/backend-libraries (1).png>) |
| ------------------------------------------------------------------------------ |
...
| ![front-end libraries scenario](<../.gitbook/assets/frontend-libraries (1).png>) |
| -------------------------------------------------------------------------------- |
...
| ![release scenario](<../.gitbook/assets/releasing (1).png>) |
| ----------------------------------------------------------- |
...
| ![bugfixing scenario](<../.gitbook/assets/bugfixing (1).png>) |
| ------------------------------------------------------------- |
