...
![Read only system process](<../../.gitbook/assets/read-only-system-process (1).png>)
...
![Setting system process property](<../../.gitbook/assets/setting-system-process-property (1).png>)
...
![System process](<../../.gitbook/assets/system-process (1).png>)
