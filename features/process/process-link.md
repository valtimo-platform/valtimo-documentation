...
![Select process link type](<../../.gitbook/assets/select-process-link-type (1).png>)
...
![Creating a plugin process link](<../../.gitbook/assets/create-plugin-process-link (1).png>)
...
![Edit a process link](<../../.gitbook/assets/edit-process-link (1).png>)
...
![Unlink a process link](<../../.gitbook/assets/edit-process-link (1).png>)
