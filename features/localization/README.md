...
![Example of custom 'Dashboard' translation](<../../.gitbook/assets/dashboard-translation (1).png>)
...
![EN translation file](<../../.gitbook/assets/en-translation-file (1).png>)

This translation is displayed in the right sidebar as "Information":

![Original sidebar translation](<../../.gitbook/assets/original-sidebar (1).png>)

We can override this text by providing the exact key using the dot notation, and then providing our own translations:

![Custom sidebar translation definition](<../../.gitbook/assets/custom-account-translation (1).png>)

Finally, our custom translation is displayed in the sidebar on reloading the page:

![Custom sidebar translation result](<../../.gitbook/assets/custom-translation-result (1).png>)
