...
* **Changeset errors on Liquibase 3.8.0 and higher**

  `foreignKeyTableName` is required for `foreignKeyConstraintExists` on Liquibase 3.8.0 and higher. Existing changesets did not implement this property.
