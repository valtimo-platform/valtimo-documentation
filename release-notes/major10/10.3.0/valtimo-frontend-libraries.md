...
*   **Added dropdown list to case search**
    ...
    It is now possible to use a multiselect dropdown or a single select dropdown when searching to cases. This can be configured in the admin menu. More information [here](/broken/pages/zQt2YHecijhlHDNfoKUh).
